...
CanvasManipulation.prototype.addCanvases = function(){
	...
	for(var i = 0; i < 9; i++){
		...
		if(i != 8)
			this.myCanvases[i].style.left = 420 + (i%3*this.canvasWidth) + "px";
		else
			this.myCanvases[i].style.left = 440 + (i%3*this.canvasWidth) + "px";
	
		if(i<3)
			this.myCanvases[i].style.top  = 180 + "px";
		else if(i >= 3 && i < 6)
			this.myCanvases[i].style.top  = 180 +  (canvasHeight) + "px";
		else
			if(i != 8)
				this.myCanvases[i].style.top  = 180 + (canvasHeight<<1) + "px";
			else
				this.myCanvases[i].style.top  = 200 + (canvasHeight<<1) + "px";
